...
export default function Events() {
    return (
        <>
            ...
            <section class="xs-banner-inner-section parallax-window" style={{backgroundImage:"url('assets/images/backgrounds/event_bg.jpg')"}}>
            ...
            <main class="xs-main">
                ...
                <section class="bg-gray xs-partner-section" style={{backgroundImage: "url('assets/images/map.png')"}}>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5">
