    ...
    <div id="content" class="app-content">
        ...
        <div class="row">
            <div class="card-body">
                ...
                <form action="{{route('updateCauses',$causes->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <table class="table table-bordered">
                        <tr>
                            <th>Title</th>
                            <td>
                                <input type="text" name="title" class="form-control" value="{{$causes->title}}">
                                
                            </td>
                            <th>Causes Category</th>
                            <td>
                                <select name="causes_category_id " id="" class="form-control form-select ">
                                    <option value="{{$causes->causes_category_id}}">{{$causes->causesCategory->name}}</option>
                        ...
                        <tr>
                            <th>Total Amount Need</th>
                            <td>
                                <input type="text" name="total_amount_need" class="form-control" value="{{$causes->total_amount_need}}">
                                
                            </td>
                            <th>Finished Date</th>
                            <td>
                                <input type="date" name="finished_date" class="form-control" value="{{$causes->finished_date}}">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{url('photo/causes/'.$causes->photo)}}" alt="" width="100px">
                            </td>
                            <th>Posted By</th>
                            <td>
                                <input type="text" name="posted_by" class="form-control" value="{{$causes->posted_by}}">
                                
                            </td>
                            
                        </tr>
                        <tr>
                            <th>Posted By Photo</th>
                            <td>
                                <input type="file" class="form-control" name="posted_by_photo">
                                <img src="{{url('photo/causes/posted_by_photo/'.$causes->posted_by_photo)}}" alt="" width="100px">
                            </td>
