                    ...
                    <form action="{{route('updateEvent',$event->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th>Title</th>
                                <th>
                                    <input type="text" name="title" class="form-control" value="{{$event->title}}" placeholder="Title">
                                    
                                </th>
                                <th>Photo One</th>
                                <td>
                                    <input type="file" name="photo" class="form-control">
                                    <img src="{{url('photo/events/'.$event->photo)}}" alt="" width="100px">
                                </td>
                            </tr>
                            <tr>
                                <th>Photo Two</th>
                                <td>
                                    ...
                                    <img src="{{url('photo/events/'.$event->photo_two)}}" alt="" width="100px">
                                </td>
                                <td>Date</td>
                                <th>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <textarea name="short_description" id="" cols="10" rows="3" class="form-control" placeholder="Short Description">{{$event->short_description}}</textarea>
                            ...
                            <tr>
                                <th>Event Mission</th>
                                <td colspan="3">
                                    <textarea name="event_mission" id="" cols="10" rows="3" class="form-control" placeholder="Event Mission">{{$event->event_mission}}</textarea>
                            ...
                            <tr>
                                <th>Event Vission</th>
                                <td colspan="3">
                                    <textarea name="event_vission" id="" cols="10" rows="3" class="form-control" placeholder="Event Vission">{{$event->event_vission}}</textarea>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <textarea name="facilities" id="" cols="15" rows="5" class="form-control" >{{$event->facilities}}</textarea>
                            ...
                            <tr>
                                <td colspan="3"></td>
                                <td><input type="submit" class="btn btn-info form-control" value="Update"></td>
                            </tr>
                        </table>
                    </form>
                </div>
