...
<div id="app" class="app">
    ...
    <div id="content" class="app-content">
        ...
        <div class="row">
            ...
            <div class="card-body">
                <h1>Awarness Area table</h1>
                <a href="{{route('awarnessAreaForm')}}" class="btn btn-default">Add Awarness</a>
                   <table class="table table-bordered" id="datatableDefault">
                        ...
                        <tbody>
                            @foreach ($awarnessData as $key=>$data)
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td>{{$data->title}}</td>
                                        ...
                                        <td>
                                            <img src="{{url('photo/awarnessArea/'.$data->photo_one)}}" alt="" width="100px">
                                        </td>
                                        <td>
                                            <img src="{{url('photo/awarnessArea/'.$data->photo_two)}}" alt="" width="100px">
                                        </td>
                                        <td>
                                            <a href="{{route('editAwarnessArea',$data->id)}}" style="color: yellowgreen" class="btn"><i class="fas fa-edit"></i></a>
                                    <form action="{{route('deleteAwarnessArea',$data->id)}}" method="post">
                                    @csrf
                                    @method('delete')
