...
<div id="app" class="app">
    ...
    <div id="content" class="app-content">
        ...
        <div class="row">
            <div class="card-body">
                <h1>Update Causes Category </h1>
                {{-- <a href="{{route('cauesesCategoryTable')}}" class="btn btn-default">Category List</a> --}}
                <form action="{{route('updateCauesesCategory',$categoryData->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Icon</th>
                            <td>
                                <input type="text" name="icon" class="form-control" value="{{$categoryData->icon}}">
                                
                            </td>
                            <th>Photo</th>
                            <td>
                                <input type="file" name="photo" class="form-control">
                                <img src="{{url('photo/causesCategory/'.$categoryData->photo)}}" alt="" width="100px">
                            </td>
                        </tr>
                        <tr>
                            <th>Description</th>
                            <td colspan="3">
                                <textarea name="description" id="" cols="15" rows="5" class="form-control">{{$categoryData->description}}</textarea>
                                
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td><input type="submit" class="btn btn-info form-control" value="Submit"></td>
                        </tr>
                    </table>
                </form>
