    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body"> 
                    <h1> Event List</h1>
                    <a href="{{route('eventForm')}}" class="btn" style="color: white">Add Event</a>
                    <table class="table-bordered display " id="datatableDefault">
                        <thead>
                            <tr>
                                <th>SL</th>
                                <th>Title</th>
                        ...
                        <tbody>
                            @foreach ($event as $k=>$e)
                                <tr>
                                    ...
                                    {{-- <td>{{$e->event_mission}}</td>
                                    <td>{{$e->event_vission}}</td>
                                    <td>{{$e->facilities}}</td>
                                    <td>{{$e->description}}</td> --}}
                                    <td>
                                        <img src="{{url('photo/events/'.$e->photo)}}" alt="" width="150px">
                                        
                                    </td>
                                    <td>
                                        <img src="{{url('photo/events/'.$e->photo_two)}}" alt="" width="150px">
                                    </td>
                                    <td>{{$e->date}}</td>
                                    <td>
                                        <a href="{{route('eventEdit',$e->id)}}" style="color: yellowgreen" class="btn"><i class="fas fa-edit"></i></a>
