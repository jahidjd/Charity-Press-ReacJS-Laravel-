...
<div id="app" class="app">
    ...
    <div id="content" class="app-content">
        ...
        <div class="row">
            ...
            <div class="card-body">
                <h1>Awarness Area Form</h1>
                <a href="{{route('awarnessAreaTable')}}" class="btn btn-default">Awarness List</a>
                    <form action="{{route('updateAwarnessArea',$awarnessData->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <table class="table table-bordered">
                            <tr>
                                <th>title</th>
                                <td>
                                    <input type="text" name="title" class="form-control" value="{{$awarnessData->title}}">
                                   
                                </td>
                                <th>Photo One</th>
                                <td>
                                    <input type="file" name="photo_one" class="form-control">
                                    <img src="{{url('photo/awarnessArea/'.$awarnessData->photo_one)}}" alt="" width="100px">
                                </td>
                            </tr>
                            <tr>
                                <td>Description</td>
                                <td colspan="3">
                                    <textarea name="description" id="" cols="15" rows="5" class="form-control">{{$awarnessData->description}}</textarea>
                            ...
                            <tr>
                                <td>Quotation</td>
                                <td colspan="3">
                                    <textarea name="quotation" id="" cols="15" rows="5" class="form-control">{{$awarnessData->quotation}}</textarea>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="{{url('photo/awarnessArea/'.$awarnessData->photo_two)}}" alt="" width="100px">
                                </td>
