...
<div id="app" class="app">
    ...
    <div id="content" class="app-content">
        ...
        <div class="row">
            <div class="card-body">
                <h1>Add Causes</h1>
                <a href="{{route('causesTable')}}" class="btn btn-default">Caueses List</a>
                <form action="{{route('saveCauses')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="total_amount_need" class="form-control" value="{{old('total_amount_need')}}">
                                @error('total_amount_need')
                                <span style="color: red">{{$message}}</span>
                            @enderror
                            </td>
                            <th>Finished Date</th>
                            <td>
                                <input type="date" name="finished_date" class="form-control" value="{{old('finished_date')}}">
                                @error('finished_date')
                                <span style="color: red">{{$message}}</span>
                            @enderror
                            </td>
                        ...
                        <tr>
                            ...
                            <th>Posted By</th>
                            <td>
                                <input type="text" name="posted_by" class="form-control" value="{{old('posted_by')}}">
                                @error('posted_by')
                                    <span style="color: red">{{$message}}</span>
                                 @enderror
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="file" class="form-control" name="posted_by_photo"></td>
                            <td colspan="2"><input type="submit" class="btn btn-info form-control" value="Submit"></td>
                        </tr>
                    </table>
                </form>
