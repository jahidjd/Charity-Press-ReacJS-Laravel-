...
<div id="app" class="app">
    ...
    <div id="content" class="app-content">
        ...
        <div class="row">
            <div class="card-body">
            <h1>Causes Category Table</h1>
            <a href="{{route('causesCategory')}}" class="btn btn-default">Add Category</a><br>
                ...
                <tbody>
                    @foreach ($categoryData as $key=>$data)
                        <tr>
                            ...
                            <td>
                                <img src="{{url('photo/causesCategory/'.$data->photo)}}" alt="" width="150px">
                                
                            </td>
                            <td>
                                <a href="{{route('editCauesesCategory',$data->id)}}" style="color: yellowgreen" class="btn"><i class="fas fa-edit"></i></a>
                                <form action="{{route('deleteCaueseCategory',$data->id)}}" method="post">
                                @csrf
                                @method('delete')
