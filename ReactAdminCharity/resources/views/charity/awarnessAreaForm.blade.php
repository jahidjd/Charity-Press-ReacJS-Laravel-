        ...
        <div class="row">
            ...
            <div class="card-body">
                ...
                <a href="{{route('awarnessAreaTable')}}" class="btn btn-default">Awarness List</a>
                    <form action="{{route('saveAwarnessArea')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Quotation</td>
                                <td colspan="3">
                                    <textarea name="quotation" id="" cols="15" rows="5" class="form-control">{{old('quotation')}}</textarea>
                                    @error('quotation')
                                        <span style="color: red">{{$message}}</span>
                                    @enderror
                                </td>
